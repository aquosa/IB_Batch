...
// DPS32Feriados.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CDPS32FeriadosApp
...
// El único objeto CDPS32FeriadosApp

CDPS32FeriadosApp theApp;


// Inicialización de CDPS32FeriadosApp
